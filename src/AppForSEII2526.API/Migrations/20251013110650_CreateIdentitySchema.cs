        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DetailedDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCardNumber = table.Column<string>(type: "nvarchar(19)", maxLength: 19, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonalMessage = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryAssignments_DeliveryDrivers_DeliveryManid",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameSurname = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewTotalPrice = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Returns_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Returns_PaymentMethods_PaymentMethodId",
                        column: x => x.PaymentMethodId,
                        principalTable: "PaymentMethods",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseProducts", x => new { x.PurchaseOrderId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnPurchaseOrderId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PurchaseOrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReturnProducts_Returns_ReturnPurchaseOrderId",
                        column: x => x.ReturnPurchaseOrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAssignments_DeliveryManid",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnProducts_ReturnPurchaseOrderId",
                table: "ReturnProducts",
                column: "ReturnPurchaseOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Returns_Name",
                table: "Returns",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Returns_PaymentMethodId",
                table: "Returns",
                column: "PaymentMethodId");
        }
